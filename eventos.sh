...
curl -s --max-time 5 https://www.futbolenvivoelsalvador.com/competicion/la-liga | pandoc -f html > $futbol
...
curl -s --max-time 5 https://www.futbolenvivoelsalvador.com/competicion/segunda-division-espana | pandoc -f html > $futbol
sed -n '/Partidos de hoy/,/[0-9][0-9]\/[0-9][0-9]\/[0-9][0-9][0-9][0-9]/p' $futbol > $canales_futbol; cat $canales_futbol | head -n -1 | tail -n +2 | sed 's/<[^>]*>//g' > $futbol
cat $futbol >> $filecanales

curl -s --max-time 5 https://www.futbolenvivoelsalvador.com/competicion/copa-del-rey | pandoc -f html > $futbol 
sed -n '/Partidos de hoy/,/[0-9][0-9]\/[0-9][0-9]\/[0-9][0-9][0-9][0-9]/p' $futbol > $canales_futbol; cat $canales_futbol | head -n -1 | tail -n +2 | sed 's/<[^>]*>//g' > $futbol
cat $futbol >> $filecanales

curl -s --max-time 5 https://www.futbolenvivoelsalvador.com/competicion/supercopa-espana | pandoc -f html > $futbol
sed -n '/Partidos de hoy/,/[0-9][0-9]\/[0-9][0-9]\/[0-9][0-9][0-9][0-9]/p' $futbol > $canales_futbol; cat $canales_futbol | head -n -1 | tail -n +2 | sed 's/<[^>]*>//g' > $futbol
cat $futbol >> $filecanales

curl -s --max-time 5 https://www.futbolenvivoelsalvador.com/competicion/liga-campeones | pandoc -f html > $futbol
sed -n '/Partidos de hoy/,/[0-9][0-9]\/[0-9][0-9]\/[0-9][0-9][0-9][0-9]/p' $futbol > $canales_futbol; cat $canales_futbol | head -n -1 | tail -n +2 | sed 's/<[^>]*>//g' > $futbol
cat $futbol >> $filecanales

curl -s --max-time 5 https://www.futbolenvivoelsalvador.com/competicion/europa-league | pandoc -f html > $futbol
sed -n '/Partidos de hoy/,/[0-9][0-9]\/[0-9][0-9]\/[0-9][0-9][0-9][0-9]/p' $futbol > $canales_futbol; cat $canales_futbol | head -n -1 | tail -n +2 | sed 's/<[^>]*>//g' > $futbol
cat $futbol >> $filecanales

curl -s --max-time 5 https://www.futbolenvivoelsalvador.com/competicion/supercopa-europa | pandoc -f html > $futbol
sed -n '/Partidos de hoy/,/[0-9][0-9]\/[0-9][0-9]\/[0-9][0-9][0-9][0-9]/p' $futbol > $canales_futbol; cat $canales_futbol | head -n -1 | tail -n +2 | sed 's/<[^>]*>//g' > $futbol
cat $futbol >> $filecanales

curl -s --max-time 5 https://www.futbolenvivoelsalvador.com/competicion/premier-league | pandoc -f html > $futbol
sed -n '/Partidos de hoy/,/[0-9][0-9]\/[0-9][0-9]\/[0-9][0-9][0-9][0-9]/p' $futbol > $canales_futbol; cat $canales_futbol | head -n -1 | tail -n +2 | sed 's/<[^>]*>//g' > $futbol
cat $futbol >> $filecanales

curl -s --max-time 5 https://www.futbolenvivoelsalvador.com/deporte/baloncesto | pandoc -f html > $file3 
...
curl -s --max-time 5 https://www.futbolenvivoelsalvador.com/deporte/automovilismo | pandoc -f html > $file4
...
curl -s --max-time 5 https://www.futbolenvivoelsalvador.com/deporte/motociclismo | pandoc -f html > $file5 
...
curl -s --max-time 5 https://www.futbolenvivoelsalvador.com/deporte/tenis | pandoc -f html > $file6
...
curl -s --max-time 5 https://www.futbolenvivoelsalvador.com/deporte/mma | pandoc -f html > $mma1
...
curl -s --max-time 5 https://www.futbolenvivoelsalvador.com/deporte/boxeo | pandoc -f html > $boxeo1
...
curl -s --max-time 5 https://www.futbolenvivoelsalvador.com/deporte/ciclismo | pandoc -f html > $ciclismo1
...
curl -s --max-time 5 https://www.futbolenvivoelsalvador.com/deporte/padel | pandoc -f html > $padel1
...
curl -s --max-time 5 https://www.futbolenvivoelsalvador.com/deporte/futbol-sala | pandoc -f html > $sala1
